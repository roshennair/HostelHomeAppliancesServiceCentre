 ...
 * @author Roshen Nair
 */
public class AppointmentUpdateForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Appointment Update Form");
    ...
    private void displayAppointmentUpdatedErrorMessage() {
	JOptionPane.showMessageDialog(
		this,
	...
	try {
	    ...
	    java.util.logging.Logger.getLogger(AppointmentUpdateForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	...
	java.awt.EventQueue.invokeLater(new Runnable() {
	    public void run() {
		new AppointmentUpdateForm().setVisible(true);
	    }
	});
    }
